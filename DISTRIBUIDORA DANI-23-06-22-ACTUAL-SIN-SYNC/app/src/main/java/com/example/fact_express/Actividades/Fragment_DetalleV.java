...
public class Fragment_DetalleV extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MM.equals("R")){
            ...
            if (c.moveToFirst()){
                do{
                    /*int idR= c.getInt(22);
                    String codbarraR = c.getString(23);
                    String productoR =c.getString(24);
                    String precioR =String.valueOf(c.getInt(26));
                    String cantidadR =c.getString(25);
                    String umR=c.getString(29);
                    int totalR=c.getInt(27);
                    String ivadescripcionR=String.valueOf(c.getInt(28));
                    int exentaR= c.getInt(17);
                    int iva5R= c.getInt(18);
                    int iva10R = c.getInt(19);
                    String mensajeR = c.getString(30);*/
                    int idR= c.getInt(0);
    ...
    //impresoras
    //if (device.getName().equals("Jolimark PP-76D")) {
    //if (device.getName().equals("4B-2033PA-7507")) {
    //if (device.getName().equals("4B-2033PA-7515")) {
    //if (device.getName().equals("4B-2033PA-7516")) {
    //if (device.getName().equals("4B-2033PA-7545")) {
    //if (device.getName().equals("4B-2033PA-7677")) {
    //if (device.getName().equals("4B-2033PA-EA92")) {
    //if (device.getName().equals("4B-2033PA-7785")) {
    //if (device.getName().equals("4B-2033PA-768C")) {
            ...
            if (mmSocket != null) {
                try {
                    ...
                    for(int i=1; i<=lista.size();i++) {
                        ...
                        msg += String.format("%1$-1s" , item.codbarra+"\n");
                    ...
                    if(txtEfectivo.getText().toString().isEmpty()) {
                        ...
                        msg += "EFECTIVO: "+txtEfectivo.getText().toString()+"\n";
                    }
